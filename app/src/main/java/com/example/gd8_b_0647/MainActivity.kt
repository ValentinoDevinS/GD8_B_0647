...
class MainActivity : AppCompatActivity() {
        ...
        try{
            ...
            try {
                ...
                for(i in 0 until jsonArrayResult.length()){
                    ...
                    modelMain.strVacinity = jsonObjectResult.getString("vicinity")
            ...
            Toast.makeText(
                this@MainActivity,
                "Oops, ada yang tidak beres, coba ulang beberapa saat lagi",
                Toast.LENGTH_SHORT
            ).show()
        }
    }
    ...
    private fun initMarker(modelList: List<ModelMain>) {
        for(i in modelList.indices) {
            ...
            overlayItem.add(
                OverlayItem(
                    modelList[i].strName, modelList[i].strVacinity, GeoPoint(
            ...
            info.strVacinity = modelList[i].strVacinity
